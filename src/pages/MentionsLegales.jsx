...
const Section = ({ title, children }) => (
  <section className="mb-8">
    <h2 className="text-lg font-semibold text-primary dark:text-accent mb-3 pb-2 border-b border-gray-100 dark:border-gray-700">{title}</h2>
    <div className="text-sm text-primary-lighter dark:text-gray-300 leading-relaxed space-y-2">{children}</div>
  </section>
)
  ...
  return (
    <div className="min-h-screen bg-surface dark:bg-gray-950">
      <div className="max-w-2xl mx-auto px-4 py-10">
        <Link to="/" className="inline-flex items-center gap-2 text-sm text-primary-lighter dark:text-gray-400 hover:text-primary dark:hover:text-accent mb-8 transition-colors">
        ...
        <Section title="1. Éditeur du site">
          <p><strong className="text-primary dark:text-accent">École Secondaire Plurielle Maritime (ESPM)</strong></p>
          ...
          <p><strong className="text-primary dark:text-accent">Pouvoir Organisateur :</strong> Pouvoir Organisateur Pluriel ASBL<br /></p>
          <p><strong className="text-primary dark:text-accent">Responsable de publication :</strong> Économat de l'ESPM<br />
          Contact : <a href="mailto:renaud.lecocq@espmaritime.be" className="hover:underline">renaud.lecocq@espmaritime.be</a></p>
          <p><strong className="text-primary dark:text-accent">Développeur de l'application :</strong> ASBL SchoolPlus (en cours de constitution)<br />
          Contact : <a href="mailto:renaud.lecocq@gmail.com" className="hover:underline">renaud.lecocq@gmail.com</a></p>
        </Section>

        <Section title="2. Hébergement">
          <p><strong className="text-primary dark:text-accent">Hébergeur (frontend) :</strong><br />
          Netlify, Inc.<br />
          ...
          <p><strong className="text-primary dark:text-accent">Base de données :</strong><br />
          ...
          <p><strong className="text-primary dark:text-accent">Authentification (SSO) :</strong><br />
        ...
        <Section title="4. Protection des données personnelles (RGPD)">
          <p><strong className="text-primary dark:text-accent">Responsable du traitement :</strong><br />
          École Secondaire Plurielle Maritime — Avenue Jean Dubrucq, 175 — 1080 Bruxelles</p>

          <p><strong className="text-primary dark:text-accent">Données collectées :</strong></p>
          <ul className="list-disc list-inside space-y-1 pl-2">
          ...
          <p><strong className="text-primary dark:text-accent">Finalités du traitement :</strong></p>
          <ul className="list-disc list-inside space-y-1 pl-2">
          ...
          <p><strong className="text-primary dark:text-accent">Base légale :</strong> obligation légale (comptabilité scolaire) et intérêt légitime de l'établissement.</p>

          <p><strong className="text-primary dark:text-accent">Durée de conservation :</strong> les données financières sont conservées conformément aux obligations légales comptables belges (7 ans). Les comptes inactifs sont supprimés à l'issue de la scolarité.</p>

          <p><strong className="text-primary dark:text-accent">Destinataires :</strong> les données ne sont pas transmises à des tiers à des fins commerciales. Seuls les prestataires techniques listés à l'article 2 y accèdent, dans le cadre strict de leur mission d'hébergement.</p>

          <p><strong className="text-primary dark:text-accent">Vos droits :</strong> conformément au Règlement (UE) 2016/679 (RGPD), vous disposez d'un droit d'accès, de rectification, d'effacement, de limitation et de portabilité de vos données, ainsi que d'un droit d'opposition. Pour exercer ces droits, contactez : <a href="mailto:info@espmaritime.be" className="hover:underline">info@espmaritime.be</a></p>
        ...
        <Section title="6. Propriété intellectuelle">
          <p><strong className="text-primary dark:text-accent">Application et code source :</strong><br />
          ...
          <p><strong className="text-primary dark:text-accent">Données scolaires et logo :</strong><br />
          ...
          <p><strong className="text-primary dark:text-accent">Contenus produits par l'établissement :</strong><br />
        ...
        <Section title="7. Développement">
          <p>L'application ESPM+ est développée sous l'égide de l'<strong className="text-primary dark:text-accent">ASBL SchoolPlus</strong> (en cours de constitution), dont l'objet social est le développement et la commercialisation de solutions numériques pour les établissements scolaires.</p>
          <p>Contributeurs :</p>
          <ul className="list-disc list-inside space-y-1 pl-2">
            <li>
              <strong className="text-primary dark:text-accent">Renaud Lecocq</strong> — conception, architecture et développement de l'application (ESPM+) ;<br />
              <span className="text-primary-lighter dark:text-gray-400">Fondateur de l'ASBL SchoolPlus · Économe, École Secondaire Plurielle Maritime</span>
            </li>
            <li>
              <strong className="text-primary dark:text-accent">Francesc Altes</strong> — conception du module <em>Conseils de guidance</em> (prototype original) ; bêta testeur des fonctions en développement ;<br />
              <span className="text-primary-lighter dark:text-gray-400">Membre du personnel, École Secondaire Plurielle Maritime</span>
            </li>
          </ul>
        ...
        <p className="text-xs text-primary-lighter dark:text-gray-500 border-t border-gray-100 dark:border-gray-700 pt-6 mt-4">
